...
function Demo() {
  ...
  const content = path === "/docs/usage" ? <ResourcePage kind="usage" onNavigate={navigate} /> : path === "/docs/contracts" ? <ResourcePage kind="contracts" onNavigate={navigate} /> : path === "/preferences" ? <ResourcePage kind="preferences" onNavigate={navigate} /> : isDocsPath(path) ? <ComponentDocsPage path={path} /> : <ComponentShowcase />;
